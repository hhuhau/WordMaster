package cn.itcast.wordmaster.model;
...
public class Word {
    ...
    public int getNextDueOffset() { return nextDueOffset; }
    public void setNextDueOffset(int nextDueOffset) { this.nextDueOffset = nextDueOffset; }
}